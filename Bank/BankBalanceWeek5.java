...
class banksystem{
    ...
    public void setter(String name,int phoneno,int Balance,String Password,int accno){
        System.out.println("");
        System.out.println("");
        this.Name = name;
        this.acc_no = accno;
    ...
    public void new_user(){
        ...
        balance = sc.nextInt();
        System.out.println("Set your password: (A-Z a-z 0-9): ");
        password = sc.next();
    ...
    public void setpassword(){
        ...
        if(temppass.equals(password)){
            ...
            temppass = sc.next();
            password = temppass;
            System.out.println("Your new password changed successfully");
        }
        else{
            System.out.println("Please enter correct password");
        }
        ...
        System.out.println("");
            switch(choice){
                case 1:{
                    ...
                    a[k] = new banksystem();
                    a[k].setter(Name, phone_no, balance, password, acc_no);
